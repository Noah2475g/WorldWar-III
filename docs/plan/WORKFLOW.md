...
| AK-1 | Sieg an Spieltag **582**, 1615 Eroberungen, 12 Kriegserklärungen (Startzahl 1914, seit T-M41-02 — die KI baut die Fabrik aus; vorher Tag 471). Dieselbe Voreinstellung mit Startzahl 2015: Tag 868, mit 1815: Tag 412 (`docs/reports/fullgame*.json`, `PROBLEME.md` 2026-09-13) |
...
| Fortschrittsachse | letzte Freischaltung **Spieltag 80** (vorher 16), **32 Minuten** Echtzeit bei Tempo 1 (vorher 6,4), **17 %** der Partie (vorher 2 %) — gegen Siegtag 471; *(korrigiert 2026-09-13: seit T-M41-02 endet die Partie mit Startzahl 1914 an Tag 582, gegen den die 80 Tage **14 %** sind)* |
