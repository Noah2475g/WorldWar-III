...
| AK-1 | Sieg an Spieltag **975**, 2589 Eroberungen, 11 Kriegserklärungen, Sieger China (Startzahl 1914, seit Block N2 der M41-Nacharbeit — der Fabrikausbau sperrt keine Stadt mehr, die KI baut nicht in erinnerten Provinzen; nach T-M41-02 Tag 582, davor 471). Dieselbe Voreinstellung mit Startzahl 2015: Tag 583, mit 1815: Tag 583 (`docs/reports/fullgame*.json`, `PROBLEME.md` 2026-09-13). Der Siegtag springt je KI-Änderung in beide Richtungen; das Tor ist 300–1500 |
