...
Erzeugt von `scripts/acceptance.mjs` am 2026-09-14 gegen `27eb98e`.
...
| AK-8 | Verpackung als Programm (T-M16-05) | ✅ erfuellt, gemessen am 2026-09-14 gegen `e82c2bc` - seither nur Dokumente und Tests, das Erzeugnis ist unveraendert, zaehlt nicht gegen V1 |
